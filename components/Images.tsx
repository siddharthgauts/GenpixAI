...
function Images() {
  ...
  return (
    <div>
        <button
        className="fixed bottom-10 right-10 bg-gray-500/90 text-white px-5 py-3 rounded-md 
      hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 font-bold z-20"
      ...
      {isLoading && (
        <p className="animate-pulse text-center pb-7 font-extralight">
          Loading <span className="text-gray-500">AI</span> Generated
          Images...
        </p>
      )}
